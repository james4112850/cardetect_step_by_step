...
def main(input_dir: Optional[str] = None, output_dir: Optional[str] = None) -> None:
    ...
    if input_dir is None:
        input_dir = os.path.join(project_root, "stepbystep", "b_crop_car")
    if output_dir is None:
        output_dir = os.path.join(project_root, "stepbystep", "c_preprocess2")
    # 嚴格檢查輸入資料夾來源
    expected_input = os.path.join(project_root, "stepbystep", "b_crop_car")
